# Generated by Django 2.2.19 on 2023-03-13 13:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thickness', models.CharField(max_length=50, verbose_name='Параметры, марка стали')),
                ('length', models.IntegerField(blank=True, null=True, verbose_name='Длина')),
                ('area', models.DecimalField(blank=True, decimal_places=3, max_digits=7, null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Квадратные метры')),
                ...
                ('price_item', models.DecimalField(decimal_places=1, default=0, max_digits=5, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Цена за ед.(п/м или шт.)')),
